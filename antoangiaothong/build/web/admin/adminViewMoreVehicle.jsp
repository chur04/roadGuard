<%-- 
    Document   : adminViewMoreVehicle
    Created on : 17 thg 3, 2025, 00:20:06
    Author     : im_chur
--%>
...
<head>
    ...
    <title>Danh Sách Phương Tiện - Cyberpunk Admin</title>
...
<body>
        ...
        <div class="main-content">
            <header>
                <div class="header-content">
                    ...
                    <h1 class="page-title">Danh Sách Phương Tiện</h1>
            ...
            <div class="content-area">
                <div class="page-header">
                    ...
                    <p>Danh sách các phương tiện đăng ký của người dùng trong hệ thống.</p>
                </div>
                ...
                <div class="filter-bar">
                    <div class="search-input">
                        ...
                        <input type="text" id="searchInput" placeholder="Tìm kiếm phương tiện...">
                    </div>
                                ...
                                <tbody>
                                    <c:forEach var="vehicle" items="${vehicles}">
                                        <tr>
                                            ...
                                            <td><span class="highlight-text">${vehicle.plateNumber}</span></td>
                                            <td>${vehicle.ownerID}</td>
                                            <td>
                                                <span class="vehicle-badge ${vehicle.brand == 'Toyota' || vehicle.brand == 'Honda' || vehicle.brand == 'Ford' ? 'vehicle-car' : vehicle.brand == 'Yamaha' || vehicle.brand == 'Suzuki' ? 'vehicle-motorcycle' : 'vehicle-truck'}">
                                                    ${vehicle.brand}
                                                </span>
                                            </td>
                                            <td>${vehicle.model}</td>
                                            ...
                                            <td>
                                                 <a href="${pageContext.request.contextPath}/AdminActionInformationUser?action=deleteVehicles&plateNumber=${vehicle.plateNumber}&userID=${vehicle.ownerID}">Delete Vehicles</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                    ...
                    <c:otherwise>
                        <div class="data-table-container">
                            <div class="empty-state">
                                ...
                                <h3>Không có phương tiện nào</h3>
                                <p>Không tìm thấy phương tiện nào được đăng ký cho người dùng này.</p>
                            </div>
                        </div>
                    </c:otherwise>
                </c:choose>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Xác nhận xóa phương tiện</h2>
            ...
            <div class="modal-body">
                ...
                <p>Biển số: <span id="plateNumberToDelete" class="highlight-text"></span></p>
            </div>
    ...
    <div id="vehicleDetailsModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Chi tiết phương tiện</h2>
                <button class="modal-close" onclick="closeVehicleDetailsModal()">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-view" onclick="closeVehicleDetailsModal()">
    ...
    <script>
                ...
                brandFilter.addEventListener('change', function() {
                    ...
                    tableRows.forEach(row => {
                        ...
                        if (brandCell) {
                            ...
                            if (brand.includes(selectedBrand)) {
                                row.style.display = '';
                            } else {
                                row.style.display = 'none';
                            }
        ...
        // Delete confirmation modal
        function confirmDelete(plateNumber, userId) {
            const modal = document.getElementById('deleteModal');
            const confirmBtn = document.getElementById('confirmDeleteBtn');
            const plateNumberSpan = document.getElementById('plateNumberToDelete');
            
            plateNumberSpan.textContent = plateNumber;
            confirmBtn.href = `${pageContext.request.contextPath}/AdminActionInformationUser?action=deleteVehicles&plateNumber=${plateNumber}&userID=${userId}`;
        ...
        function viewVehicleDetails(vehicleId) {
            ...
            const vehicleRow = document.querySelector(`.data-table tbody tr td:first-child:contains('${vehicleId}')`).parentNode;
            if (vehicleRow) {
                const plateNumber = vehicleRow.cells[1].textContent;
                const brand = vehicleRow.cells[3].textContent.trim();
                const model = vehicleRow.cells[4].textContent;
                const year = vehicleRow.cells[5].textContent;
                ...
                contentDiv.innerHTML = `
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                        <div>
                            <p style="color: rgba(224, 224, 255, 0.7); margin-bottom: 5px;">ID Phương tiện:</p>
                            <p style="font-weight: 500;">${vehicleId}</p>
                        </div>
                        <div>
                            <p style="color: rgba(224, 224, 255, 0.7); margin-bottom: 5px;">Biển số:</p>
                            <p style="font-weight: 500; color: var(--primary);">${plateNumber}</p>
                        </div>
                        <div>
                            <p style="color: rgba(224, 224, 255, 0.7); margin-bottom: 5px;">Hãng xe:</p>
                            <p style="font-weight: 500;">${brand}</p>
                        </div>
                        <div>
                            <p style="color: rgba(224, 224, 255, 0.7); margin-bottom: 5px;">Mẫu xe:</p>
                            <p style="font-weight: 500;">${model}</p>
                        </div>
                        <div>
                            <p style="color: rgba(224, 224, 255, 0.7); margin-bottom: 5px;">Năm sản xuất:</p>
                            <p style="font-weight: 500;">${year}</p>
                        </div>
                        <div>
                            <p style="color: rgba(224, 224, 255, 0.7); margin-bottom: 5px;">Trạng thái:</p>
                            <p style="font-weight: 500;"><span style="color: var(--success);">Đang hoạt động</span></p>
                        </div>
                    </div>
                `;
            } else {
                contentDiv.innerHTML = '<p>Không thể tìm thấy thông tin phương tiện.</p>';
            }
